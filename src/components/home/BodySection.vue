            ...
            <div class="row g-6 mb-6">
              <div v-for="i in 10" :key="i" class="col-xl-4">
                ...
                <div class="card mb-0">
                  ...
                  <div class="card-body">
                    ...
                    >
                      ...
                      <div class="d-flex flex-stack flex-wrap">
                        <!--begin::Label-->
                        <span class="text-muted fw-bolder pe-2"
                      ...
                      <div class="carousel-inner pt-9">
                        ...
                        <div class="carousel-item active">
                          ...
                          <div class="flex-grow-1">
                            <!--begin::Title-->
                            <h3
                              class="fs-3 text-gray-800 text-hover-primary fw-bolder cursor-pointer"
                            >
                              Subject {{ i }}
                            </h3>
                            <!--end::Title-->
                  ...
                  <!--begin::Footer-->
                  <div
                    class="card-footer border-0 d-flex flex-stack pt-0 pb-10"
                  >
                    <!--begin::Label-->
                    <span class="text-muted fs-6 fw-bold pe-2"
                      >256 R St. Manhattan NY..</span
                    >
                    <!--end::Label-->
                    <a
                      href="#"
                      class="btn btn-sm btn-primary fw-bolder px-6"
          ...
          <div class="modal-dialog modal-dialog-centered mw-1000px">
            <div class="modal-content">
              <div class="container px-10 py-10">
                <div
                  class="modal-header py-2 d-flex justify-content-end border-0"
                >
                  <!--begin::Close-->
                  <div
                ...
                <div class="modal-body">
                  <!--begin::Stepper-->
                  <div
                    class="stepper stepper-1 d-flex flex-column flex-xl-row flex-row-fluid"
                  ...
                  >
                    ...
                    <div class="d-flex flex-row-fluid justify-content-center">
                      <!--begin::Form-->
                      <form
                        class="pb-5 w-100 w-md-400px w-xl-500px"
                      ...
                      >
                        ...
                        <div class="pb-5" data-kt-stepper-element="content">
                          <div class="w-100">
                            ...
                            <!--begin::Form Group-->
                            <div class="fv-row">
                              <label class="fs-6 fw-bolder text-dark mb-7"
                                >Select your app framework</label
                              >
                              <!--begin:Option-->
                              <label
                                class="d-flex flex-stack cursor-pointer mb-6"
                              >
                                <span class="d-flex align-items-center me-2">
                                  <span class="symbol symbol-50px me-6">
                                    <span class="symbol-label bg-light-warning">
                                      <i
                                        class="fab fa-html5 text-warning fs-2x"
                                      ></i>
                                    </span>
                                  </span>
                                  <span class="d-flex flex-column">
                              ...
                              >
                                <span class="d-flex align-items-center me-2">
                                  <span class="symbol symbol-50px me-6">
                                    <span class="symbol-label bg-light-success">
                                      <i
                                        class="fab fa-react text-success fs-2x"
                                      ></i>
                                    </span>
                                  </span>
                                  <span class="d-flex flex-column">
                              ...
                              >
                                <span class="d-flex align-items-center me-2">
                                  <span class="symbol symbol-50px me-6">
                                    <span class="symbol-label bg-light-danger">
                                      <i
                                        class="fab fa-angular text-danger fs-2x"
                                      ></i>
                                    </span>
                                  </span>
                                  <span class="d-flex flex-column">
                              ...
                              >
                                <span class="d-flex align-items-center me-2">
                                  <span class="symbol symbol-50px me-6">
                                    <span class="symbol-label bg-light-primary">
                                      <i
                                        class="fab fa-vuejs text-primary fs-2x"
                                      ></i>
                                    </span>
                                  </span>
                                  <span class="d-flex flex-column">
                        ...
                        <div class="pb-5" data-kt-stepper-element="content">
                          <div class="w-100">
                            ...
                            <div class="fv-row">
                              <label class="fs-6 fw-bolder text-dark mb-7"
                                >Select your app database solution</label
                              >
                              <!--begin:Option-->
                              <label
                                class="d-flex flex-stack cursor-pointer mb-6"
                              >
                                <span class="d-flex align-items-center me-2">
                                  <span class="symbol symbol-50px me-6">
                                    <span class="symbol-label bg-light-success">
                                      <i
                                        class="fas fa-database text-success fs-2x"
                                      ></i>
                                    </span>
                                  </span>
                                  <span class="d-flex flex-column">
                              ...
                              >
                                <span class="d-flex align-items-center me-2">
                                  <span class="symbol symbol-50px me-6">
                                    <span class="symbol-label bg-light-danger">
                                      <i
                                        class="fab fa-google text-danger fs-2x"
                                      ></i>
                                    </span>
                                  </span>
                                  <span class="d-flex flex-column">
                              ...
                              >
                                <span class="d-flex align-items-center me-2">
                                  <span class="symbol symbol-50px me-6">
                                    <span class="symbol-label bg-light-warning">
                                      <i
                                        class="fab fa-amazon text-warning fs-2x"
                                      ></i>
                                    </span>
                                  </span>
                                  <span class="d-flex flex-column">
                        ...
                        <div class="pb-5" data-kt-stepper-element="content">
                          <div class="w-100">
                            ...
                            <div class="fv-row">
                              <label class="fs-6 fw-bolder text-dark mb-7"
                                >Select your app storage solution</label
                              >
                              <!--begin:Option-->
                              <label
                                class="d-flex flex-stack cursor-pointer mb-6"
                              >
                                <span class="d-flex align-items-center me-2">
                                  <span class="symbol symbol-50px me-6">
                                    <span class="symbol-label bg-light-primary">
                                      <i
                                        class="fab fa-linux text-primary fs-2x"
                                      ></i>
                                    </span>
                                  </span>
                                  <span class="d-flex flex-column">
                                    ...
                                    >
                                    <span class="fs-7 text-muted"
                                      >Linux based server storage</span
                                    >
                                  </span>
                                </span>
                                <span
                              ...
                              >
                                <span class="d-flex align-items-center me-2">
                                  <span class="symbol symbol-50px me-6">
                                    <span class="symbol-label bg-light-warning">
                                      <i
                                        class="fab fa-aws text-warning fs-2x"
                                      ></i>
                                    </span>
                                  </span>
                                  <span class="d-flex flex-column">
                              ...
                              >
                                <span class="d-flex align-items-center me-2">
                                  <span class="symbol symbol-50px me-6">
                                    <span class="symbol-label bg-light-success">
                                      <i
                                        class="fab fa-google text-success fs-2x"
                                      ></i>
                                    </span>
                                  </span>
                                  <span class="d-flex flex-column">
                        ...
                        <div class="d-flex justify-content-between pt-10">
                          ...
                          <div>
                            <button
                              type="button"
                              class="btn btn-lg btn-primary fw-bolder py-4 ps-8 me-3"
